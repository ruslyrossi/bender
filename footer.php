...
<div id="footer">
    ...
    <div class="wrapper">
      ...
      <div class="block">
        ...
        <div class="site-desc">
Cuba.my is an Online Classifieds Website & Business Directory performs to connect buyers & sellers for promoting their products, services and businesses locally.&nbsp;&nbsp;&nbsp;<a href="http://www.cuba.my/item/new">Post Free Ads</a></div>
      </div>
<p></p>
        <ul>
        ...
        if( osc_get_preference('footer_link', 'bender_theme') !== '0') {
            ...
            echo '<div>Copyright © 2014. All rights reserved - Cuba.my. Powered by <a target="_blank" title="eCommerce Malaysia" href="http://mices.com.my/">Mices Technology</a></div>';
