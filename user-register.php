...
<div class="form-container form-horizontal form-container-box">
    ...
    <div class="resp-wrapper">
        <form name="register" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <div class="controls">
                    <div class="left"><button type="submit" class="ui-button ui-button-middle ui-button-main login_button"><?php _e("Create", 'bender'); ?></button></div><div class="left"><?php fbc_button(); ?></div>
                    <div class="clear"></div>
                </div>
            </div>
        </form>
