        ...
        <div class="listing-cell">
            <div class="listing-data">
                <div class="listing-basicinfo">
                    <a href="<?php echo osc_item_url() ; ?>" class="title" title="<?php echo osc_item_title() ; ?>"><?php echo osc_title_prefix(osc_item_id()); ?> <?php echo osc_highlight( osc_item_title()) ; ?></a>
                    <div class="listing-attributes">
                        ...
                        <?php if(price_status(osc_item_category_id()) == true) { ?>
                        	<?php if( osc_price_enabled_at_items() ) { ?><span class="currency-value"><?php echo osc_format_price(osc_item_price()); ?></span><?php } ?>
                        <?php } ?>
                        
                    </div>
                    <p class="loop_single_desc"><?php echo osc_highlight( strip_tags( osc_item_description()) ,250) ; ?></p>
                </div>
                <?php if($admin){ ?>
