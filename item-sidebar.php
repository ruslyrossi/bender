    ...
    <div id="contact" class="widget-box form-container form-vertical">
        ...
        <?php } else { ?>
            ...
            <?php if( osc_item_show_phone()) { ?>
                <p class="email"><?php printf(__('Phone: %s', 'bender'), osc_item_contact_phone()); ?></p>
            <?php } ?>
            
            
            <?php 
			if(osc_item_contact_email()) {
			?>
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="post" name="contact_form" id="contact_form" <?php if(osc_item_attachment()) { echo 'enctype="multipart/form-data"'; };?> >
                    ...
                    <div class="control-group">
                        <div class="left" style="width:20px; padding-top:5px;"><?php ContactForm::what_apps(); ?></div>
                        <div class="left" style="width:200px;"><label class="control-label" for="what_apps"><?php _e('Publisher can message me through WhatApps', 'bender'); ?></label></div>
                        <div class="clear"></div>
                    </div>
