...
<h1><a class="category <?php echo osc_category_slug() ; ?>" href="<?php echo osc_search_category_url() ; ?>"><img src="<?php echo osc_current_web_theme_url('cubaextra/maincategoryicons/') . osc_category_name() .'.png' ?>" width="50px" height="50px" alt="" title=""/><?php echo osc_category_name() ; ?></a></a> <span><strong>(<?php echo osc_category_total_items() ; ?>)</strong></span></h1>
...
// ref: http://forums.osclass.org/general-help/filter-categories-by-city/
function CatCountByRegion($region,$catID){
...
WHERE s_region = '%s'", DB_TABLE_PREFIX, DB_TABLE_PREFIX, $allCats, $region);
		return $test['count'];
	}
?>